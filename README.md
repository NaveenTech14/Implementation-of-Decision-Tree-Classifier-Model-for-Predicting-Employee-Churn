...
## Algorithm
1. Import the required libraries and create the employee churn dataset using a pandas DataFrame.

2. Encode the categorical variables (Departments and salary) into numerical values using one-hot encoding.

3. Split the dataset into training and testing sets and train the Decision Tree Classifier model.

4. Predict employee churn using the test data and evaluate the model using confusion matrix, accuracy score, classification report, and visualize the decision tree.
